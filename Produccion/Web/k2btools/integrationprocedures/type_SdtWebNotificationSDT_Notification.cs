...
namespace GeneXus.Programs.k2btools.integrationprocedures
{
	...
	[XmlType(TypeName="Notification" , Namespace="EstadoCuenta" )]
	[Serializable]
	...
	[DataContract(Name=@"Notification", Namespace="EstadoCuenta")]
	public class SdtWebNotificationSDT_Notification_RESTInterface : GxGenericCollectionItem<SdtWebNotificationSDT_Notification>, System.Web.SessionState.IRequiresSessionState
	{
		...
		{
			get { 
				return DateTimeUtil.TToC3( sdt.gxTpr_Eventcreationdatetime,context);

			}
			set { 
				sdt.gxTpr_Eventcreationdatetime = DateTimeUtil.CToT2(value,context);
			}
		}
