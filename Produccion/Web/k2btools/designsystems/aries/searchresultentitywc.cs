   ...
   public class searchresultentitywc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "K2 BTools Search Result Entity WCAries") ;
      ...
      {
         return "K2 BTools Search Result Entity WCAries" ;
      }
      ...
      protected void WB160( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_162( true) ;
         }
         else
         {
            wb_table1_6_162( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_162e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START162( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "K2 BTools Search Result Entity WCAries", 0) ;
            context.wjLoc = "";
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTITIESRESULTSGRIDLARGE.LOAD") == 0 )
                                 {
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          ...
                                          GX_FocusControl = edtavNextpage_action_Internalname;
                                          AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
                                          /* Execute user event: Entitiesresultsgridlarge.Load */
                                          E14162 ();
                                       }
                                    }
                                 }
      ...
      protected void S112( )
      {
         ...
         AV24ResultsEntities = new GXBaseCollection<SdtK2BSearchResult_Item>( context, "Item", "EstadoCuenta");
         gx_BV12 = true;
      ...
      protected void wb_table1_6_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No results found", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/SearchResultEntityWC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_6_162e( true) ;
         }
         else
         {
            wb_table1_6_162e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243510201842", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/searchresultentitywc.js", "?20243510201842", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTITIESRESULTSGRIDLARGE.LOAD","{handler:'E14162',iparms:[{av:'AV24ResultsEntities',fld:'vRESULTSENTITIES',grid:12,pic:''},{av:'nGXsfl_12_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:12},{av:'ENTITIESRESULTSGRIDLARGE_nFirstRecordOnPage'},{av:'nRC_GXsfl_12',ctrl:'ENTITIESRESULTSGRIDLARGE',prop:'GridRC',grid:12}]");
