   ...
   public class viewallnotifications : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB130( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Notificaciones", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/ViewAllNotifications.htm");
            ...
            GxWebStd.gx_label_element( context, cmbavGridsettingsrowsperpage_gridgetallnotificationsforcurrentuserdp_Internalname, "Filas por página", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp_Internalname, "Inmovilizar títulos", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp_Internalname, StringUtil.BoolToStr( AV30FreezeColumnTitles_GridGetAllNotificationsForCurrentUserDP), "", "Inmovilizar títulos", 1, chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(53, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,53);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      private void E21132( )
      {
         ...
         while ( AV34GXV2 <= AV6DP_SDT_GridGetAllNotificationsForCurrentUserDP.Count )
         {
            ...
            AssignAttri("", false, chkavNotificationisread_Internalname, AV15NotificationIsRead);
            AV17Open_Action = "Abrir";
            AssignAttri("", false, edtavOpen_action_Internalname, AV17Open_Action);
            AV11MarkAsRead_Action = "Marcar como leído";
            AssignAttri("", false, edtavMarkasread_action_Internalname, AV11MarkAsRead_Action);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243510202248", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2btools/designsystems/aries/viewallnotifications.js", "?20243510202248", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp.Caption = "Inmovilizar títulos";
