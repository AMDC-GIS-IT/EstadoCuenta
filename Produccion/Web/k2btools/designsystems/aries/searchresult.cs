...
namespace GeneXus.Programs.k2btools.designsystems.aries {
   public class searchresult : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         return "K2 BTools Search Result Aries" ;
      }
      ...
      protected void START0W2( )
      {
         ...
         Form.Meta.addItem("description", "K2 BTools Search Result Aries", 0) ;
         context.wjLoc = "";
      ...
      protected void S112( )
      {
         /* 'LOADALLTABS' Routine */
         returnInSub = false;
         AV11Tabs = new GXBaseCollection<SdtK2BTabOptions_K2BTabOptionsItem>( context, "K2BTabOptionsItem", "EstadoCuenta");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243510202445", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2btools/designsystems/aries/searchresult.js", "?20243510202445", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "K2 BTools Search Result Aries";
      ...
      public override void initialize( )
      {
         ...
         AV11Tabs = new GXBaseCollection<SdtK2BTabOptions_K2BTabOptionsItem>( context, "K2BTabOptionsItem", "EstadoCuenta");
         AV9Tab = new SdtK2BTabOptions_K2BTabOptionsItem(context);
         AV12GXV1 = new GXBaseCollection<SdtSearchableTransactions_SearchableTransactionsItem>( context, "SearchableTransactionsItem", "EstadoCuenta");
