   ...
   public class tabbedviewforuniversalsearch : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "K2 BTabbed View For Layout Aries Universal Search") ;
      ...
      {
         return "K2 BTabbed View For Layout Aries Universal Search" ;
      }
      ...
      protected void WB150( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgTabprevious_Internalname, sImgUrl, imgTabprevious_Link, "", "", context.GetTheme( ), imgTabprevious_Visible, 1, "", "Previous Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BTools/DesignSystems/Aries/TabbedViewForUniversalSearch.htm");
            /* Static images/pictures */
            ...
            GxWebStd.gx_bitmap( context, imgTabnext_Internalname, sImgUrl, imgTabnext_Link, "", "", context.GetTheme( ), imgTabnext_Visible, 1, "", "Next Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BTools/DesignSystems/Aries/TabbedViewForUniversalSearch.htm");
      ...
      protected void START152( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "K2 BTabbed View For Layout Aries Universal Search", 0) ;
            context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243510201830", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/tabbedviewforuniversalsearch.js", "?20243510201830", false, true);
      ...
      {
         AV18Tabs = new GXBaseCollection<SdtK2BTabOptions_K2BTabOptionsItem>( context, "K2BTabOptionsItem", "EstadoCuenta");
         wcpOGx_mode = "";
         wcpOAV15TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
