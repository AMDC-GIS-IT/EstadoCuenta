   ...
   public class notificationsviewer : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "K2 BT_Notifications Viewer Aries") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"subNotificationsgrid_Recordcount", StringUtil.LTrim( StringUtil.NToC( (decimal)(subNotificationsgrid_Recordcount), 5, 0, ".", "")));
      ...
      {
         return "K2 BT_Notifications Viewer Aries" ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_action_Internalname, "Ver todas", "", "", lblViewall_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e110t1_client"+"'", "", "K2BT_TextAction", 7, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEnablenotifications_action_Internalname, "Habilitar notificaciones en escritorio", "", "", lblEnablenotifications_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e120t1_client"+"'", "", "K2BT_TextAction", 7, "", lblEnablenotifications_action_Visible, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRefresh_action_Internalname, "Refrescar", "", "", lblRefresh_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e130t1_client"+"'", "", "K2BT_TextAction", 7, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
         ...
         if ( wbEnd == 21 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_notificationsgrid_Internalname, "No tiene notificaciones", "", "", lblI_noresultsfoundtextblock_notificationsgrid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0T2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "K2 BT_Notifications Viewer Aries", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "NOTIFICATIONSGRID_NOTIFICATIONCONTAINER.CLICK") == 0 )
                           {
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: Notificationsgrid_notificationcontainer.Click */
                                    E150T2 ();
                                 }
                              }
                           }
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 25), "NOTIFICATIONSGRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "NOTIFICATIONSGRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 24), "VMARKASREAD_ACTION.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "'E_VIEWNOTIFICATION'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 45), "NOTIFICATIONSGRID_NOTIFICATIONCONTAINER.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "ONMESSAGE_GX1") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 24), "VMARKASREAD_ACTION.CLICK") == 0 ) )
                           {
                              ...
                              {
                                 AV30NotificationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtavNotificationid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
                                 AssignAttri(sPrefix, false, edtavNotificationid_Internalname, StringUtil.LTrimStr( (decimal)(AV30NotificationId), 15, 0));
                              }
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "NOTIFICATIONSGRID.REFRESH") == 0 )
                                 {
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          ...
                                          GX_FocusControl = edtavNotificationtext_Internalname;
                                          AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
                                          /* Execute user event: Notificationsgrid.Refresh */
                                          E190T2 ();
                                       }
                                    }
                                 }
                                 else if ( StringUtil.StrCmp(sEvt, "NOTIFICATIONSGRID.LOAD") == 0 )
                                 {
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          ...
                                          GX_FocusControl = edtavNotificationtext_Internalname;
                                          AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
                                          /* Execute user event: Notificationsgrid.Load */
                                          E200T2 ();
                                       }
                                    }
                                 }
      ...
      protected void STRUP0T0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            subNotificationsgrid_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"subNotificationsgrid_Recordcount"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E170T2( )
      {
         ...
         AssignProp(sPrefix, false, edtavMarkasread_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV24MarkAsRead_Action)) ? AV39Markasread_action_GXI : context.convertURL( context.PathToRelativeUrl( AV24MarkAsRead_Action))), !bGXsfl_21_Refreshing);
         AssignProp(sPrefix, false, edtavMarkasread_action_Internalname, "SrcSet", context.GetImageSrcSet( AV24MarkAsRead_Action), true);
         AV39Markasread_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "dfbe6635-f23c-4133-8627-41bb5fc11325", "", context.GetTheme( )), context);
         AssignProp(sPrefix, false, edtavMarkasread_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV24MarkAsRead_Action)) ? AV39Markasread_action_GXI : context.convertURL( context.PathToRelativeUrl( AV24MarkAsRead_Action))), !bGXsfl_21_Refreshing);
         AssignProp(sPrefix, false, edtavMarkasread_action_Internalname, "SrcSet", context.GetImageSrcSet( AV24MarkAsRead_Action), true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243510201865", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/notificationsviewer.js", "?20243510201865", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BTools.DesignSystems.Aries.NotificationsButtonRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void sendrow_212( )
      {
         ...
         NotificationsgridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkavNotificationisread_Internalname,StringUtil.BoolToStr( AV32NotificationIsRead),(string)"",(string)"Notification Is Read",(short)1,(short)1,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"",(string)"",TempTags+" onclick="+"\"gx.fn.checkboxClick(43, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+((chkavNotificationisread.Enabled!=0)&&(chkavNotificationisread.Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,43);\"" : " ")});
         NotificationsgridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         NotificationsgridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         /* Div Control */
      ...
      public override void initialize_properties( )
      {
         ...
         K2bt_notificationsbutton1_Caption = "E_Toggle Notifications";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("NOTIFICATIONSGRID.REFRESH","{handler:'E190T2',iparms:[]");
         ...
         setEventMetadata("NOTIFICATIONSGRID.LOAD","{handler:'E200T2',iparms:[{av:'AV12DP_SDT_ITEM_NotificationsGrid',fld:'vDP_SDT_ITEM_NOTIFICATIONSGRID',pic:'',hsh:true}]");
         ...
         setEventMetadata("VMARKASREAD_ACTION.CLICK","{handler:'E210T2',iparms:[{av:'NOTIFICATIONSGRID_nFirstRecordOnPage'},{av:'NOTIFICATIONSGRID_nEOF'},{av:'AV24MarkAsRead_Action',fld:'vMARKASREAD_ACTION',pic:''},{av:'edtavMarkasread_action_Tooltiptext',ctrl:'vMARKASREAD_ACTION',prop:'Tooltiptext'},{av:'AV12DP_SDT_ITEM_NotificationsGrid',fld:'vDP_SDT_ITEM_NOTIFICATIONSGRID',pic:'',hsh:true},{av:'sPrefix'},{av:'AV30NotificationId',fld:'vNOTIFICATIONID',pic:'ZZZZZZZZZZZZZZ9'}]");
         ...
         setEventMetadata("'E_VIEWNOTIFICATION'","{handler:'E140T2',iparms:[{av:'AV15EventTargetUrl',fld:'vEVENTTARGETURL',pic:''},{av:'NOTIFICATIONSGRID_nFirstRecordOnPage'},{av:'NOTIFICATIONSGRID_nEOF'},{av:'AV24MarkAsRead_Action',fld:'vMARKASREAD_ACTION',pic:''},{av:'edtavMarkasread_action_Tooltiptext',ctrl:'vMARKASREAD_ACTION',prop:'Tooltiptext'},{av:'AV12DP_SDT_ITEM_NotificationsGrid',fld:'vDP_SDT_ITEM_NOTIFICATIONSGRID',pic:'',hsh:true},{av:'sPrefix'},{av:'AV30NotificationId',fld:'vNOTIFICATIONID',pic:'ZZZZZZZZZZZZZZ9'}]");
         ...
         setEventMetadata("NOTIFICATIONSGRID_NOTIFICATIONCONTAINER.CLICK","{handler:'E150T2',iparms:[{av:'AV15EventTargetUrl',fld:'vEVENTTARGETURL',pic:''},{av:'NOTIFICATIONSGRID_nFirstRecordOnPage'},{av:'NOTIFICATIONSGRID_nEOF'},{av:'AV24MarkAsRead_Action',fld:'vMARKASREAD_ACTION',pic:''},{av:'edtavMarkasread_action_Tooltiptext',ctrl:'vMARKASREAD_ACTION',prop:'Tooltiptext'},{av:'AV12DP_SDT_ITEM_NotificationsGrid',fld:'vDP_SDT_ITEM_NOTIFICATIONSGRID',pic:'',hsh:true},{av:'sPrefix'},{av:'AV30NotificationId',fld:'vNOTIFICATIONID',pic:'ZZZZZZZZZZZZZZ9'}]");
         ...
         setEventMetadata("'E_VIEWALL'","{handler:'E110T1',iparms:[]");
         setEventMetadata("'E_VIEWALL'",",oparms:[]}");
         setEventMetadata("'E_REFRESH'","{handler:'E130T1',iparms:[{av:'NOTIFICATIONSGRID_nFirstRecordOnPage'},{av:'NOTIFICATIONSGRID_nEOF'},{av:'AV24MarkAsRead_Action',fld:'vMARKASREAD_ACTION',pic:''},{av:'edtavMarkasread_action_Tooltiptext',ctrl:'vMARKASREAD_ACTION',prop:'Tooltiptext'},{av:'AV12DP_SDT_ITEM_NotificationsGrid',fld:'vDP_SDT_ITEM_NOTIFICATIONSGRID',pic:'',hsh:true},{av:'sPrefix'}]");
         ...
         setEventMetadata("ENABLENOTIFICATIONS_ACTION.CLICK","{handler:'E120T1',iparms:[]");
         setEventMetadata("ENABLENOTIFICATIONS_ACTION.CLICK",",oparms:[]}");
         setEventMetadata("ONMESSAGE_GX1","{handler:'E160T2',iparms:[{av:'NOTIFICATIONSGRID_nFirstRecordOnPage'},{av:'NOTIFICATIONSGRID_nEOF'},{av:'AV24MarkAsRead_Action',fld:'vMARKASREAD_ACTION',pic:''},{av:'edtavMarkasread_action_Tooltiptext',ctrl:'vMARKASREAD_ACTION',prop:'Tooltiptext'},{av:'AV12DP_SDT_ITEM_NotificationsGrid',fld:'vDP_SDT_ITEM_NOTIFICATIONSGRID',pic:'',hsh:true},{av:'sPrefix'},{av:'AV31NotificationInfo',fld:'vNOTIFICATIONINFO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV13DP_SDT_NotificationsGrid = new GXBaseCollection<GeneXus.Programs.k2btools.integrationprocedures.SdtWebNotificationSDT_Notification>( context, "Notification", "EstadoCuenta");
         GXt_objcol_SdtWebNotificationSDT_Notification3 = new GXBaseCollection<GeneXus.Programs.k2btools.integrationprocedures.SdtWebNotificationSDT_Notification>( context, "Notification", "EstadoCuenta");
