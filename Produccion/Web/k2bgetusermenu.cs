...
namespace GeneXus.Programs {
   public class k2bgetusermenu : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV10SecurityMenu.gxTpr_Title = "Seguridad";
         AV10SecurityMenu.gxTpr_Imageclass = "fa fa-lock";
         ...
         AV11SecurityItem.gxTpr_Title = "Cambiar Contraseña";
         AV11SecurityItem.gxTpr_Imageclass = "fa fa-key";
