...
namespace GeneXus.Programs {
   public class k2blogout : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void START2R2( )
      {
         ...
         Form.Meta.addItem("description", "K2 BLogout", 0) ;
         context.wjLoc = "";
      ...
      protected void E112R2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV5ConfirmMessage = "Are you sure you want to logout?";
         AssignAttri("", false, "AV5ConfirmMessage", AV5ConfirmMessage);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243510202452", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2blogout.js", "?20243510202452", false, true);
