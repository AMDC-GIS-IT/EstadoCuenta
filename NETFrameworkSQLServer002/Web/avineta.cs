      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               getPrinter().GxDrawText(context.GetMessage( "Nombre:", ""), 58, Gx_line+133, 125, Gx_line+155, 0, 0, 0, 1) ;
               ...
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Fecha:", ""), 508, Gx_line+133, 558, Gx_line+155, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.localUtil.Format( AV23Fecha3, "99/99/9999"), 558, Gx_line+133, 658, Gx_line+155, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Identidad:", ""), 58, Gx_line+167, 133, Gx_line+189, 0, 0, 0, 1) ;
               getPrinter().GxDrawText(context.GetMessage( "Clave Catastral:", ""), 508, Gx_line+167, 616, Gx_line+189, 0, 0, 0, 1) ;
               getPrinter().GxDrawText(context.GetMessage( "Codigo de UMAPS:", ""), 58, Gx_line+200, 191, Gx_line+222, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               ...
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Colonia: ", ""), 508, Gx_line+200, 575, Gx_line+222, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
   ...
   public class avineta__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000F2", "SELECT [UMAPS], [RUTA] AS CLAVES_RUTASRUTA, [CLAVE_CATASTRAL] FROM dbo.[CLAVES_RUTAS] WHERE [RUTA] = 138 ORDER BY [CLAVE_CATASTRAL] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000F2,100, GxCacheFrequency.OFF ,true,false )
