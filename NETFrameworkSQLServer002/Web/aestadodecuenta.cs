   ...
   public class aestadodecuenta : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               getPrinter().GxDrawText(context.GetMessage( "Nombre:", ""), 25, Gx_line+183, 92, Gx_line+205, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 20, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Alcaldía Municipal del Distrito Cental", ""), 108, Gx_line+17, 683, Gx_line+67, 1, 0, 0, 1) ;
               ...
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Tegucigalpa, Honduras", ""), 108, Gx_line+50, 683, Gx_line+100, 1, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 11, true, false, false, false, 0, 128, 128, 128, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "GERENCIA DE RECAUDACIÓN Y CONTROL FINANCIERO", ""), 108, Gx_line+80, 683, Gx_line+130, 1, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 12, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "ESTADO DE CUENTA ", ""), 108, Gx_line+130, 683, Gx_line+163, 1, 0, 0, 0) ;
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Fecha:", ""), 492, Gx_line+183, 542, Gx_line+205, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.localUtil.Format( AV23Fecha3, "99/99/9999"), 542, Gx_line+183, 642, Gx_line+205, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Identidad:", ""), 25, Gx_line+217, 100, Gx_line+239, 0, 0, 0, 1) ;
               getPrinter().GxDrawText(context.GetMessage( "Clave Catastral:", ""), 300, Gx_line+217, 408, Gx_line+239, 0, 0, 0, 1) ;
               getPrinter().GxDrawRect(8, Gx_line+267, 808, Gx_line+298, 1, 0, 0, 0, 1, 92, 206, 223, 0, 1, 0, 0, 0, 0, 0, 0) ;
               getPrinter().GxDrawText(context.GetMessage( "Año", ""), 8, Gx_line+267, 91, Gx_line+298, 1, 0, 0, 1) ;
               ...
               getPrinter().GxDrawText(context.GetMessage( "Impuesto", ""), 92, Gx_line+267, 217, Gx_line+298, 1, 0, 0, 1) ;
               getPrinter().GxDrawLine(367, Gx_line+267, 367, Gx_line+298, 1, 0, 0, 0, 0) ;
               getPrinter().GxDrawText(context.GetMessage( "Tren de Aseo", ""), 217, Gx_line+267, 367, Gx_line+298, 1, 0, 0, 1) ;
               getPrinter().GxDrawText(context.GetMessage( "Tasa de Bomberos", ""), 367, Gx_line+267, 534, Gx_line+298, 1, 0, 0, 1) ;
               getPrinter().GxDrawLine(533, Gx_line+267, 533, Gx_line+298, 1, 0, 0, 0, 0) ;
               getPrinter().GxDrawText(context.GetMessage( "Recargos", ""), 533, Gx_line+267, 666, Gx_line+298, 1, 0, 0, 1) ;
               getPrinter().GxDrawLine(667, Gx_line+267, 667, Gx_line+298, 1, 0, 0, 0, 0) ;
               getPrinter().GxDrawText(context.GetMessage( "Total", ""), 667, Gx_line+267, 809, Gx_line+298, 1, 0, 0, 1) ;
               getPrinter().GxDrawText(context.GetMessage( "Hora:", ""), 650, Gx_line+183, 700, Gx_line+205, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.localUtil.Format( AV55Hora, "99:99:99"), 692, Gx_line+183, 784, Gx_line+205, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "Colonia:", ""), 542, Gx_line+217, 600, Gx_line+239, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Arial", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               ...
               AV56Mensaje = context.GetMessage( "Recuerda que puedes aprovechar el descuento por pronto pago que vence el 30 a abril y la amnistía que esta vigente hasta el 30 de Junio.", "");
               AV57Mensaje2 = context.GetMessage( "Datos actualizados al 29 de febrero del 2024.", "");
               H0E0( false, 400) ;
               ...
               getPrinter().GxDrawLine(92, Gx_line+0, 92, Gx_line+31, 1, 0, 0, 0, 0) ;
               getPrinter().GxAttris("Arial", 10, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(context.GetMessage( "TOTAL", ""), 8, Gx_line+0, 91, Gx_line+31, 1, 0, 0, 1) ;
               ...
               getPrinter().GxDrawText(context.GetMessage( "Total a Pagar:", ""), 8, Gx_line+67, 116, Gx_line+89, 0, 0, 0, 1) ;
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aestadodecuenta__default(),
            new Object[][] {
                new Object[] {
               P000E2_A6CLAVES_RUTASRUTA, P000E2_n6CLAVES_RUTASRUTA, P000E2_A1CLAVE_CATASTRAL
               }
               , new Object[] {
   ...
   public class aestadodecuenta__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000E2", "SELECT [RUTA], [CLAVE_CATASTRAL] FROM dbo.[CLAVES_RUTAS] WHERE [RUTA] = @AV13Clave ORDER BY [CLAVE_CATASTRAL] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000E2,100, GxCacheFrequency.OFF ,true,false )
