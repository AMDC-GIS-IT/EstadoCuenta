   ...
   public class k2bnotauthorized : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "EntityName");
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV8TransactionName = GetPar( "TransactionName");
                  ...
                  AV7StandardActivityType = GetPar( "StandardActivityType");
                  ...
                  AV9UserActivityType = GetPar( "UserActivityType");
                  ...
                  AV6ProgramName = GetPar( "ProgramName");
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( context.GetMessage( "K2B Not Authorized", "")) ;
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("k2bnotauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV5EntityName)),UrlEncode(StringUtil.RTrim(AV8TransactionName)),UrlEncode(StringUtil.RTrim(AV7StandardActivityType)),UrlEncode(StringUtil.RTrim(AV9UserActivityType)),UrlEncode(StringUtil.RTrim(AV6ProgramName))}, new string[] {"EntityName","TransactionName","StandardActivityType","UserActivityType","ProgramName"}) +"\">") ;
      ...
      {
         return context.GetMessage( "K2B Not Authorized", "") ;
      }
      ...
      protected void START0A2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2B Not Authorized", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E110A2( )
      {
         /* Start Routine */
         returnInSub = false;
         GX_msglist.addItem(context.GetMessage( "You are not authorized to do activity", ""));
         GX_msglist.addItem(context.GetMessage( "EntityName:", "")+AV5EntityName);
         GX_msglist.addItem(context.GetMessage( "TransactionName:", "")+AV8TransactionName);
         if ( StringUtil.StrCmp(AV7StandardActivityType, "None") == 0 )
         {
            GX_msglist.addItem(context.GetMessage( "ActivityType : ", "")+AV9UserActivityType);
         }
         else
         {
            GX_msglist.addItem(context.GetMessage( "ActivityType: ", "")+AV7StandardActivityType);
         }
         GX_msglist.addItem(context.GetMessage( "PgmName :", "")+AV6ProgramName);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462533", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bnotauthorized.js", "?2024341462533", false, true);
         }
