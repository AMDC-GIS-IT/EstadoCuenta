...
namespace GeneXus.Programs {
   public class claves_rutas : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "CLAVES_RUTAS", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "CLAVES_RUTAS", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_CLAVES_RUTAS.htm");
         ...
         GxWebStd.gx_label_element( context, edtCLAVE_CATASTRAL_Internalname, context.GetMessage( "CLAVE_CATASTRAL", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtCLAVES_RUTASRUTA_Internalname, context.GetMessage( "RUTA", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 39,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtCLAVES_RUTASRUTA_Internalname, StringUtil.LTrim( StringUtil.NToC( A6CLAVES_RUTASRUTA, 18, 6, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtCLAVES_RUTASRUTA_Enabled!=0) ? context.localUtil.Format( A6CLAVES_RUTASRUTA, "ZZZZZZZZZZ9.999999") : context.localUtil.Format( A6CLAVES_RUTASRUTA, "ZZZZZZZZZZ9.999999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'6');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'6');"+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCLAVES_RUTASRUTA_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCLAVES_RUTASRUTA_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_CLAVES_RUTAS.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtUMAPS_Internalname, context.GetMessage( "UMAPS", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtUMAPS_Internalname, StringUtil.LTrim( StringUtil.NToC( A7UMAPS, 18, 6, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtUMAPS_Enabled!=0) ? context.localUtil.Format( A7UMAPS, "ZZZZZZZZZZ9.999999") : context.localUtil.Format( A7UMAPS, "ZZZZZZZZZZ9.999999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'6');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'6');"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUMAPS_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtUMAPS_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_CLAVES_RUTAS.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtClavesRutaId_Internalname, context.GetMessage( "Claves Ruta Id", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 49,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtClavesRutaId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A8ClavesRutaId), 9, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtClavesRutaId_Enabled!=0) ? context.localUtil.Format( (decimal)(A8ClavesRutaId), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A8ClavesRutaId), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClavesRutaId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtClavesRutaId_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_CLAVES_RUTAS.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_enter_Internalname, "", context.GetMessage( "GX_BtnEnter", ""), bttBtn_enter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_CLAVES_RUTAS.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "", context.GetMessage( "GX_BtnCancel", ""), bttBtn_cancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_CLAVES_RUTAS.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         ClassString = "Button button-tertiary";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_delete_Internalname, "", context.GetMessage( "GX_BtnDelete", ""), bttBtn_delete_Jsonclick, 5, context.GetMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_CLAVES_RUTAS.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z6CLAVES_RUTASRUTA = context.localUtil.CToN( cgiGet( "Z6CLAVES_RUTASRUTA"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep"));
            n6CLAVES_RUTASRUTA = ((Convert.ToDecimal(0)==A6CLAVES_RUTASRUTA) ? true : false);
            Z7UMAPS = context.localUtil.CToN( cgiGet( "Z7UMAPS"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep"));
            n7UMAPS = ((Convert.ToDecimal(0)==A7UMAPS) ? true : false);
            Z8ClavesRutaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "Z8ClavesRutaId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtCLAVES_RUTASRUTA_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtCLAVES_RUTASRUTA_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > 99999999999.999999m ) ) )
            {
            ...
            {
               A6CLAVES_RUTASRUTA = context.localUtil.CToN( cgiGet( edtCLAVES_RUTASRUTA_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep"));
               n6CLAVES_RUTASRUTA = false;
               AssignAttri("", false, "A6CLAVES_RUTASRUTA", StringUtil.LTrimStr( A6CLAVES_RUTASRUTA, 18, 6));
            }
            n6CLAVES_RUTASRUTA = ((Convert.ToDecimal(0)==A6CLAVES_RUTASRUTA) ? true : false);
            if ( ( ( context.localUtil.CToN( cgiGet( edtUMAPS_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtUMAPS_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > 99999999999.999999m ) ) )
            {
            ...
            {
               A7UMAPS = context.localUtil.CToN( cgiGet( edtUMAPS_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep"));
               n7UMAPS = false;
               AssignAttri("", false, "A7UMAPS", StringUtil.LTrimStr( A7UMAPS, 18, 6));
            }
            n7UMAPS = ((Convert.ToDecimal(0)==A7UMAPS) ? true : false);
            if ( ( ( context.localUtil.CToN( cgiGet( edtClavesRutaId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtClavesRutaId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 999999999 )) ) )
            {
            ...
            {
               A8ClavesRutaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtClavesRutaId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               n8ClavesRutaId = false;
               AssignAttri("", false, "A8ClavesRutaId", StringUtil.LTrimStr( (decimal)(A8ClavesRutaId), 9, 0));
            }
            n8ClavesRutaId = ((0==A8ClavesRutaId) ? true : false);
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z6CLAVES_RUTASRUTA", StringUtil.LTrim( StringUtil.NToC( Z6CLAVES_RUTASRUTA, 18, 6, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "Z7UMAPS", StringUtil.LTrim( StringUtil.NToC( Z7UMAPS, 18, 6, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "Z8ClavesRutaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z8ClavesRutaId), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "CLAVES_RUTAS", "") ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462794", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("claves_rutas.js", "?2024341462794", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "CLAVES_RUTAS", "");
         bttBtn_delete_Enabled = 1;
