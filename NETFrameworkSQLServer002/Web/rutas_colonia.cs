...
namespace GeneXus.Programs {
   public class rutas_colonia : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "RUTAS_COLONIA", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "RUTAS_COLONIA", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_RUTAS_COLONIA.htm");
         ...
         GxWebStd.gx_label_element( context, edtRUTAS_COLONIARUTA_Internalname, context.GetMessage( "RUTA", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 34,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtRUTAS_COLONIARUTA_Internalname, StringUtil.LTrim( StringUtil.NToC( A3RUTAS_COLONIARUTA, 18, 6, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtRUTAS_COLONIARUTA_Enabled!=0) ? context.localUtil.Format( A3RUTAS_COLONIARUTA, "ZZZZZZZZZZ9.999999") : context.localUtil.Format( A3RUTAS_COLONIARUTA, "ZZZZZZZZZZ9.999999"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'6');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, gx.thousandSeparator,gx.decimalPoint,'6');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRUTAS_COLONIARUTA_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtRUTAS_COLONIARUTA_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_RUTAS_COLONIA.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtCOLONIA_Internalname, context.GetMessage( "COLONIA", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Multiple line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtRutaColoniaId_Internalname, context.GetMessage( "Ruta Colonia Id", ""), "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtRutaColoniaId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5RutaColoniaId), 9, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtRutaColoniaId_Enabled!=0) ? context.localUtil.Format( (decimal)(A5RutaColoniaId), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A5RutaColoniaId), "ZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRutaColoniaId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtRutaColoniaId_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_RUTAS_COLONIA.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_enter_Internalname, "", context.GetMessage( "GX_BtnEnter", ""), bttBtn_enter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_RUTAS_COLONIA.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "", context.GetMessage( "GX_BtnCancel", ""), bttBtn_cancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_RUTAS_COLONIA.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         ClassString = "Button button-tertiary";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_delete_Internalname, "", context.GetMessage( "GX_BtnDelete", ""), bttBtn_delete_Jsonclick, 5, context.GetMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_RUTAS_COLONIA.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            Z3RUTAS_COLONIARUTA = context.localUtil.CToN( cgiGet( "Z3RUTAS_COLONIARUTA"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep"));
            Z4COLONIA = cgiGet( "Z4COLONIA");
            Z5RutaColoniaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "Z5RutaColoniaId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            IsConfirmed = (short)(Math.Round(context.localUtil.CToN( cgiGet( "IsConfirmed"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            IsModified = (short)(Math.Round(context.localUtil.CToN( cgiGet( "IsModified"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            Gx_mode = cgiGet( "Mode");
            /* Read variables values. */
            if ( ( ( context.localUtil.CToN( cgiGet( edtRUTAS_COLONIARUTA_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtRUTAS_COLONIARUTA_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > 99999999999.999999m ) ) )
            {
            ...
            {
               A3RUTAS_COLONIARUTA = context.localUtil.CToN( cgiGet( edtRUTAS_COLONIARUTA_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep"));
               AssignAttri("", false, "A3RUTAS_COLONIARUTA", StringUtil.LTrimStr( A3RUTAS_COLONIARUTA, 18, 6));
            }
            A4COLONIA = cgiGet( edtCOLONIA_Internalname);
            AssignAttri("", false, "A4COLONIA", A4COLONIA);
            if ( ( ( context.localUtil.CToN( cgiGet( edtRutaColoniaId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtRutaColoniaId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 999999999 )) ) )
            {
            ...
            {
               A5RutaColoniaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtRutaColoniaId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A5RutaColoniaId", StringUtil.LTrimStr( (decimal)(A5RutaColoniaId), 9, 0));
            }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z3RUTAS_COLONIARUTA", StringUtil.LTrim( StringUtil.NToC( Z3RUTAS_COLONIARUTA, 18, 6, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "Z4COLONIA", Z4COLONIA);
         GxWebStd.gx_hidden_field( context, "Z5RutaColoniaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z5RutaColoniaId), 9, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "RUTAS_COLONIA", "") ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462521", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("rutas_colonia.js", "?2024341462521", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "RUTAS_COLONIA", "");
         bttBtn_delete_Enabled = 1;
