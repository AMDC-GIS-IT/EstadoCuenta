...
namespace GeneXus.Programs {
   public class k2blogout : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public k2blogout( )
      {
      ...
      public k2blogout( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("k2blogout.aspx") +"\">") ;
      ...
      {
         return formatLink("k2blogout.aspx")  ;
      }
      ...
      {
         return context.GetMessage( "K2 BLogout", "") ;
      }
      ...
      protected void START2R2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "K2 BLogout", ""), 0) ;
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'CONFIRMNO'") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: 'ConfirmNo' */
                              E132R2 ();
                           }
      ...
      protected void PA2R2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavConfirmmessage_Internalname;
      ...
      protected void STRUP2R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV5ConfirmMessage = cgiGet( edtavConfirmmessage_Internalname);
            AssignAttri("", false, "AV5ConfirmMessage", AV5ConfirmMessage);
      ...
      protected void E112R2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV5ConfirmMessage = context.GetMessage( "Are you sure you want to logout?", "");
         AssignAttri("", false, "AV5ConfirmMessage", AV5ConfirmMessage);
      }
      ...
      protected void wb_table1_6_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_9_2R2( true) ;
         }
         else
         {
            wb_table2_9_2R2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_2R2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_9_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_12_2R2( true) ;
         }
         else
         {
            wb_table3_12_2R2( false) ;
         }
         return  ;
      }

      protected void wb_table3_12_2R2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_2R2e( true) ;
         }
         else
         {
            wb_table2_9_2R2e( false) ;
         }
      }

      protected void wb_table3_12_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_element( context, edtavConfirmmessage_Internalname, context.GetMessage( "Confirm Message", ""), "gx-form-item Attribute_ConditionalConfirmLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavConfirmmessage_Internalname, StringUtil.RTrim( AV5ConfirmMessage), StringUtil.RTrim( context.localUtil.Format( AV5ConfirmMessage, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConfirmmessage_Jsonclick, 0, "Attribute_ConditionalConfirm", "", "", "", "", 1, edtavConfirmmessage_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_K2BLogout.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_19_2R2( true) ;
         }
         else
         {
            wb_table4_19_2R2( false) ;
         }
         return  ;
      }

      protected void wb_table4_19_2R2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_12_2R2e( true) ;
         }
         else
         {
            wb_table3_12_2R2e( false) ;
         }
      }

      protected void wb_table4_19_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmyes_Internalname, "", context.GetMessage( "K2BT_ConfirmOk", ""), bttI_buttonconfirmyes_Jsonclick, 5, context.GetMessage( "K2BT_ConfirmOk", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMYES\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BLogout.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 24,'',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmno_Internalname, "", context.GetMessage( "K2BT_ConfirmCancel", ""), bttI_buttonconfirmno_Jsonclick, 5, context.GetMessage( "K2BT_ConfirmCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMNO\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BLogout.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_19_2R2e( true) ;
         }
         else
         {
            wb_table4_19_2R2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462625", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2blogout.js", "?2024341462625", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "K2 BLogout", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CONFIRMYES'","{handler:'E122R2',iparms:[]");
         setEventMetadata("'CONFIRMYES'",",oparms:[]}");
         setEventMetadata("'CONFIRMNO'","{handler:'E132R2',iparms:[]");
         setEventMetadata("'CONFIRMNO'",",oparms:[]}");
         return  ;
      }
      ...
      private string AV5ConfirmMessage ;
