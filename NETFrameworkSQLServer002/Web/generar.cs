...
namespace GeneXus.Programs {
   public class generar : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public generar( )
      {
      ...
      public generar( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("generar.aspx") +"\">") ;
      ...
      {
         return formatLink("generar.aspx")  ;
      }
      ...
      {
         return context.GetMessage( "Generar", "") ;
      }
      ...
      protected void WB2U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpGroup_Internalname, context.GetMessage( "Ingrese los Datos Correspondientes", ""), 1, 0, "px", 0, "px", "Group_Tabular", "", "HLP_Generar.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTable_container_ruta_Internalname, 1, 0, "px", 0, "px", "K2BT_NGA K2BToolsTable_TopAttributeContainer", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group gx-label-top", "start", "top", ""+" data-gx-for=\""+edtavRuta_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavRuta_Internalname, context.GetMessage( "Ingrese el Codigo de Ruta", ""), "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 35,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavRuta_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12Ruta), 18, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtavRuta_Enabled!=0) ? context.localUtil.Format( (decimal)(AV12Ruta), "ZZZZZZZZZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV12Ruta), "ZZZZZZZZZZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavRuta_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtavRuta_Enabled, 0, "text", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, false, "", "end", false, "", "HLP_Generar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAction_Internalname, "", context.GetMessage( "Generar Estados", ""), bttAction_Jsonclick, 7, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e112u1_client"+"'", TempTags, "", 2, "HLP_Generar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divColumn2_Internalname, 1, 0, "px", 0, "px", "K2BT_NGA", "start", "top", "", "", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2U2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Generar", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA2U2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavRuta_Internalname;
      ...
      protected void S142( )
      {
         /* 'U_ACTION' Routine */
         returnInSub = false;
         context.PopUp(formatLink("aestadodecuenta.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12Ruta,18,0))}, new string[] {"Clave"}) , new Object[] {});
         context.PopUp(formatLink("avineta.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12Ruta,18,0))}, new string[] {"Clave"}) , new Object[] {});
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024359394661", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("generar.js", "?2024359394661", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtavRuta_Internalname = "vRUTA";
         divTable_container_ruta_Internalname = "TABLE_CONTAINER_RUTA";
         bttAction_Internalname = "ACTION";
         ...
         divColumn2_Internalname = "COLUMN2";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Generar", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'E_ACTION'","{handler:'E112U1',iparms:[{av:'AV12Ruta',fld:'vRUTA',pic:'ZZZZZZZZZZZZZZZZZ9'}]");
         setEventMetadata("'E_ACTION'",",oparms:[]}");
         return  ;
      }
      ...
      private int edtavRuta_Enabled ;
      private int idxLst ;
      private long AV12Ruta ;
      ...
      private string divTable_container_ruta_Internalname ;
      private string edtavRuta_Internalname ;
      private string TempTags ;
      private string edtavRuta_Jsonclick ;
      private string bttAction_Internalname ;
      private string bttAction_Jsonclick ;
      private string divColumn2_Internalname ;
