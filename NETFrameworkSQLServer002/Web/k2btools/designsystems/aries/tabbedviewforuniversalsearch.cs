...
namespace GeneXus.Programs.k2btools.designsystems.aries {
   public class tabbedviewforuniversalsearch : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462111", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/tabbedviewforuniversalsearch.js", "?2024341462111", false, true);
