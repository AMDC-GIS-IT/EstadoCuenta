   ...
   public class notificationsviewer : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_action_Internalname, context.GetMessage( "K2BT_ViewAllNotifications", ""), "", "", lblViewall_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e110t1_client"+"'", "", "K2BT_TextAction", 7, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEnablenotifications_action_Internalname, context.GetMessage( "K2BT_Notif_EnableWebNotifications", ""), "", "", lblEnablenotifications_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e120t1_client"+"'", "", "K2BT_TextAction", 7, "", lblEnablenotifications_action_Visible, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRefresh_action_Internalname, context.GetMessage( "K2BT_RefreshAction", ""), "", "", lblRefresh_action_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e130t1_client"+"'", "", "K2BT_TextAction", 7, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/NotificationsViewer.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462316", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/notificationsviewer.js", "?2024341462316", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BTools.DesignSystems.Aries.NotificationsButtonRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
