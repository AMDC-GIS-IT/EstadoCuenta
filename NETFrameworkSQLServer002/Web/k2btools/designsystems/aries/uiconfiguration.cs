   ...
   public class uiconfiguration : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2 BT_UIConfiguration Aries", "")) ;
      ...
      {
         return context.GetMessage( "K2 BT_UIConfiguration Aries", "") ;
      }
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock_palette_Internalname, context.GetMessage( "K2BT_Palette", ""), "", "", lblTextblock_palette_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BT_LabelTop Label", 0, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/UIConfiguration.htm");
            /* Div Control */
      ...
      protected void START0U2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "K2 BT_UIConfiguration Aries", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void E120U2( )
      {
         ...
         AV10K2BT_ExtendedControlValuesItem.gxTpr_Description = context.GetMessage( "Light", "");
         ...
         AV10K2BT_ExtendedControlValuesItem.gxTpr_Description = context.GetMessage( "Dark", "");
         AV9K2BT_ExtendedControlValues.Add(AV10K2BT_ExtendedControlValuesItem, 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024359382155", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/uiconfiguration.js", "?2024359382155", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BToggleBar/K2BToggleBarRender.js", "", false, true);
