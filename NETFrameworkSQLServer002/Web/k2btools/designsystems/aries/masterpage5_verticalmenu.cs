...
namespace GeneXus.Programs.k2btools.designsystems.aries {
   public class masterpage5_verticalmenu : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      public masterpage5_verticalmenu( )
      {
      ...
      public masterpage5_verticalmenu( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "K2BTools.DesignSystems.Aries.MasterPage5_VerticalMenu";
               WS0Y2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  WE0Y2( ) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "CENTERSTART_MPAGE_Class", StringUtil.RTrim( divCenterstart_Class));
      ...
      protected void RenderHtmlCloseForm0Y2( )
      {
         ...
         context.AddJavascriptSource("k2btools/designsystems/aries/masterpage5_verticalmenu.js", "?2024341462741", false, true);
      ...
      {
         return "K2BTools.DesignSystems.Aries.MasterPage5_VerticalMenu" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Left fixed vertical menu 5", "") ;
      }
      ...
      protected void WB0Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divMaintable_Internalname, 1, 0, "px", 0, "px", "MasterPage2", "start", "top", " "+"data-gx-flex"+" ", "", "div");
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divCenterstart_Internalname, 1, 0, "px", 0, "px", divCenterstart_Class, "start", "top", " "+"data-gx-flex"+" ", "flex-direction:column;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 12,'',true,'',0)\"";
            ClassString = "K2BToolsButton_BtnToggle InvisibleInSmallButton InvisibleInMediumButton InvisibleInLargeButton";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttTogglemenu_Internalname, "", "|||", bttTogglemenu_Jsonclick, 7, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e110y1_client"+"'", TempTags, "", 2, "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-shrink:0;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divBeforemenusection_Internalname, 1, 0, "px", 0, "px", "K2BT_HeaderArea", "start", "top", " "+"data-gx-flex"+" ", "flex-direction:column;", "div");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, imgApplicationicon_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgApplicationicon_Jsonclick, "'"+""+"'"+",true,"+"'"+"e120y1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "K2BT_HeaderItem K2BT_AlignBottom", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblApplicationname_Internalname, context.GetMessage( "Application name", ""), "", "", lblApplicationname_Jsonclick, "'"+""+"'"+",true,"+"'"+"e130y1_client"+"'", "", "K2BT_ApplicationName", 7, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUserinitialstextblocksmall_Internalname, lblUserinitialstextblocksmall_Caption, "", "", lblUserinitialstextblocksmall_Jsonclick, "'"+""+"'"+",true,"+"'"+"e140y1_client"+"'", "", "K2BToolsTextblock_InitialsCircleSmall", 7, "", lblUserinitialstextblocksmall_Visible, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, imgavUseravatarsmall_Internalname, sImgUrl, "", "", "", context.GetTheme( ), imgavUseravatarsmall_Visible, 1, "", "", 0, -1, 0, "", 0, "", 0, 0, 7, imgavUseravatarsmall_Jsonclick, "'"+""+"'"+",true,"+"'"+"e140y1_client"+"'", StyleString, ClassString, "", "", "", "", ""+TempTags, "", "", 1, AV12UserAvatarSmall_IsBlob, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUsernametextblock_Internalname, lblUsernametextblock_Caption, "", "", lblUsernametextblock_Jsonclick, "'"+""+"'"+",true,"+"'"+"e140y1_client"+"'", "", "K2BToolsTextBlock_MyAccount", 7, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divMyaccountmenu_Internalname, divMyaccountmenu_Visible, 0, "px", 0, "px", "K2BT_UserOptions", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblChangepassword_Internalname, context.GetMessage( "K2BT_GAM_ChangePassword", ""), "", "", lblChangepassword_Jsonclick, "'"+""+"'"+",true,"+"'"+"e150y1_client"+"'", "", "K2BToolsTextBlock_ChangePassword", 7, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSignout_Internalname, context.GetMessage( "K2BT_GAM_SignOut", ""), "", "", lblSignout_Jsonclick, "'"+""+"'"+",true,"+"'"+"ESIGNOUT_MPAGE."+"'", "", "K2BToolsTextBlock_Logout", 5, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divMenucontainer_Internalname, 1, 0, "px", 0, "px", "K2BToolsMenuContainer", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            ClassString = "K2BToolsButton_BtnToggle InvisibleInSmallButton InvisibleInMediumButton InvisibleInLargeButton";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttMenutoggle_Internalname, "", "|||", bttMenutoggle_Jsonclick, 7, "", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e110y1_client"+"'", TempTags, "", 2, "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSearchcriteria_Internalname, context.GetMessage( "Search Criteria", ""), "gx-form-item K2BTools_SearchCriteriaLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 49,'',true,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSearchcriteria_Internalname, StringUtil.RTrim( AV9SearchCriteria), StringUtil.RTrim( context.localUtil.Format( AV9SearchCriteria, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", context.GetMessage( "Search", ""), edtavSearchcriteria_Jsonclick, 0, "K2BTools_SearchCriteria", "", "", "", "", 1, edtavSearchcriteria_Enabled, 0, "text", "", 26, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "K2BSearchCriteria", "start", true, "", "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Active images/pictures */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 50,'',true,'',0)\"";
            ClassString = "K2BToolsButton_Search" + " " + ((StringUtil.StrCmp(imgImage2_gximage, "")==0) ? "GX_Image_K2BT_Search_OverContent_Class" : "GX_Image_"+imgImage2_gximage+"_Class");
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "c73ed2f5-40ab-4019-aeb3-ba4a34e950a7", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgImage2_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage2_Jsonclick, "'"+""+"'"+",true,"+"'"+"e160y1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_K2BTools/DesignSystems/Aries/MasterPage5_VerticalMenu.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            if ( ! isFullAjaxMode( ) )
            {
               ...
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpMPW0056"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( ! context.isAjaxRequest( ) )
               {
                  context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpMPW0056"+"");
               }
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "M") == 0 )
                  {
                     ...
                     if ( nCmpId == 54 )
                     {
                        ...
                        WebComp_Notificationscomponent.componentprocess("MPW0054", "", sEvt);
                     }
                     else if ( nCmpId == 56 )
                     {
                        ...
                        WebComp_Uiconfiguration.componentprocess("MPW0056", "", sEvt);
                     }
                     else if ( nCmpId == 62 )
                     {
                        ...
                        WebComp_Footercomponent.componentprocess("MPW0062", "", sEvt);
                     }
                  }
      ...
      protected void RF0Y2( )
      {
         ...
         if ( ShowMPWhenPopUp( ) || ! context.isPopUpObject( ) )
         {
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
            {
               ...
               WebComp_Notificationscomponent.componentprepare(new Object[] {(string)"MPW0054",(string)""});
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
            {
               ...
               WebComp_Uiconfiguration.componentprepare(new Object[] {(string)"MPW0056",(string)""});
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
            {
               ...
               WebComp_Footercomponent.componentprepare(new Object[] {(string)"MPW0062",(string)""});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2024341462767", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btools/designsystems/aries/masterpage5_verticalmenu.js", "?2024341462768", false, true);
         context.AddJavascriptSource("K2BAccordionMenu/metisMenu-master/dist/metisMenu.min.js", "", false, true);
         context.AddJavascriptSource("K2BAccordionMenu/K2BAccordionMenuRender.js", "", false, true);
      ...
      {
         bttTogglemenu_Internalname = "TOGGLEMENU_MPAGE";
         ...
         divBeforemenusection_Internalname = "BEFOREMENUSECTION_MPAGE";
      ...
      public override void initialize_properties( )
      {
         ...
         lblUserinitialstextblocksmall_Visible = 1;
         divCenterstart_Class = "K2BT_FixedMenu";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DOSEARCH_MPAGE","{handler:'E160Y1',iparms:[{av:'AV9SearchCriteria',fld:'vSEARCHCRITERIA_MPAGE',pic:''}]");
         setEventMetadata("DOSEARCH_MPAGE",",oparms:[{av:'AV9SearchCriteria',fld:'vSEARCHCRITERIA_MPAGE',pic:''}]}");
         setEventMetadata("TOGGLEMENU_MPAGE","{handler:'E110Y1',iparms:[{av:'divCenterstart_Class',ctrl:'CENTERSTART_MPAGE',prop:'Class'}]");
         setEventMetadata("TOGGLEMENU_MPAGE",",oparms:[{av:'divCenterstart_Class',ctrl:'CENTERSTART_MPAGE',prop:'Class'}]}");
         setEventMetadata("OPENTABLE_MPAGE","{handler:'E140Y1',iparms:[{av:'divMyaccountmenu_Visible',ctrl:'MYACCOUNTMENU_MPAGE',prop:'Visible'}]");
         setEventMetadata("OPENTABLE_MPAGE",",oparms:[{av:'divMyaccountmenu_Visible',ctrl:'MYACCOUNTMENU_MPAGE',prop:'Visible'}]}");
         setEventMetadata("CHANGEPASSWORD_MPAGE","{handler:'E150Y1',iparms:[]");
         setEventMetadata("CHANGEPASSWORD_MPAGE",",oparms:[]}");
         setEventMetadata("SIGNOUT_MPAGE","{handler:'E190Y2',iparms:[]");
         setEventMetadata("SIGNOUT_MPAGE",",oparms:[]}");
         setEventMetadata("APPLICATIONICON_MPAGE.CLICK_MPAGE","{handler:'E120Y1',iparms:[]");
         setEventMetadata("APPLICATIONICON_MPAGE.CLICK_MPAGE",",oparms:[]}");
         setEventMetadata("APPLICATIONNAME_MPAGE.CLICK_MPAGE","{handler:'E130Y1',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         GX_FocusControl = "";
         AV15GXV1 = new GXBaseCollection<SdtK2BAttributeValue_Item>( context, "Item", "EstadoCuenta");
         ...
         AV8SearchableTransactions = new GXBaseCollection<SdtSearchableTransactions_SearchableTransactionsItem>( context, "SearchableTransactionsItem", "EstadoCuenta");
         GXt_objcol_SdtSearchableTransactions_SearchableTransactionsItem3 = new GXBaseCollection<SdtSearchableTransactions_SearchableTransactionsItem>( context, "SearchableTransactionsItem", "EstadoCuenta");
      ...
      private int idxLst ;
      private string divCenterstart_Class ;
      ...
      private string bttTogglemenu_Internalname ;
      private string bttTogglemenu_Jsonclick ;
      private string divBeforemenusection_Internalname ;
