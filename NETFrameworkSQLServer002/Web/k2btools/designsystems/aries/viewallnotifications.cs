...
namespace GeneXus.Programs.k2btools.designsystems.aries {
   public class viewallnotifications : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCURRENTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5CurrentPage_GridGetAllNotificationsForCurrentUserDP), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vHASNEXTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP", AV9HasNextPage_GridGetAllNotificationsForCurrentUserDP);
         GxWebStd.gx_hidden_field( context, "gxhash_vHASNEXTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP", GetSecureSignedToken( "", AV9HasNextPage_GridGetAllNotificationsForCurrentUserDP, context));
         GxWebStd.gx_hidden_field( context, "vROWSPERPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18RowsPerPage_GridGetAllNotificationsForCurrentUserDP), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vDP_SDT_ITEM_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP", AV7DP_SDT_ITEM_GridGetAllNotificationsForCurrentUserDP);
         }
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vDP_SDT_ITEM_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP", GetSecureSignedToken( "", AV7DP_SDT_ITEM_GridGetAllNotificationsForCurrentUserDP, context));
         GxWebStd.gx_hidden_field( context, "subGridgetallnotificationsforcurrentuserdp_Recordcount", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGridgetallnotificationsforcurrentuserdp_Recordcount), 5, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "View All Notifications", "") ;
      }
      ...
      protected void WB130( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, context.GetMessage( "K2BT_Notifications", ""), "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/ViewAllNotifications.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridgetallnotificationsforcurrentuserdpruntimecolumnselectiontb_Internalname, context.GetMessage( "K2BT_GridSettingsLabel", ""), "", "", lblGslayoutdefined_gridgetallnotificationsforcurrentuserdpruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/ViewAllNotifications.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_label_element( context, cmbavGridsettingsrowsperpage_gridgetallnotificationsforcurrentuserdp_Internalname, context.GetMessage( "K2BT_RowsPerPage", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp_Internalname, context.GetMessage( "K2BT_FreezeColumnTitles", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp_Internalname, StringUtil.BoolToStr( AV30FreezeColumnTitles_GridGetAllNotificationsForCurrentUserDP), "", context.GetMessage( "K2BT_FreezeColumnTitles", ""), 1, chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(53, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,53);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 65 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_74_132( true) ;
         }
         else
         {
            wb_table1_74_132( false) ;
         }
         return  ;
      }

      protected void wb_table1_74_132e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START132( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "View All Notifications", ""), 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 8), "'E_OPEN'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "'E_MARKASREAD'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 47), "GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 44), "GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 8), "'E_OPEN'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "'E_MARKASREAD'") == 0 ) )
                           {
                              ...
                              {
                                 AV14NotificationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtavNotificationid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
                                 AssignAttri("", false, edtavNotificationid_Internalname, StringUtil.LTrimStr( (decimal)(AV14NotificationId), 15, 0));
                                 GxWebStd.gx_hidden_field( context, "gxhash_vNOTIFICATIONID"+"_"+sGXsfl_65_idx, GetSecureSignedToken( sGXsfl_65_idx, context.localUtil.Format( (decimal)(AV14NotificationId), "ZZZZZZZZZZZZZZ9"), context));
                              }
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP.REFRESH") == 0 )
                                 {
                                    context.wbHandled = 1;
                                    dynload_actions( ) ;
                                    /* Execute user event: Gridgetallnotificationsforcurrentuserdp.Refresh */
                                    E20132 ();
                                 }
                                 else if ( StringUtil.StrCmp(sEvt, "GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP.LOAD") == 0 )
                                 {
                                    context.wbHandled = 1;
                                    dynload_actions( ) ;
                                    /* Execute user event: Gridgetallnotificationsforcurrentuserdp.Load */
                                    E21132 ();
                                 }
      ...
      protected void STRUP130( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV18RowsPerPage_GridGetAllNotificationsForCurrentUserDP = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vROWSPERPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV5CurrentPage_GridGetAllNotificationsForCurrentUserDP = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vCURRENTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            ...
            subGridgetallnotificationsforcurrentuserdp_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( "subGridgetallnotificationsforcurrentuserdp_Recordcount"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void S162( )
      {
         ...
         else
         {
            ...
            while ( AV33GXV1 <= AV13Messages.Count )
            {
               ...
               new GeneXus.Core.genexus.common.SdtLog(context).error(context.GetMessage( "Error marking notification as read: ", "")+AV12Message.gxTpr_Id+" - "+AV12Message.gxTpr_Description, context.GetMessage( "K2BTools.Notifications.ViewAllNotifications", "")) ;
      ...
      private void E21132( )
      {
         ...
         while ( AV34GXV2 <= AV6DP_SDT_GridGetAllNotificationsForCurrentUserDP.Count )
         {
            ...
            AssignAttri("", false, chkavNotificationisread_Internalname, AV15NotificationIsRead);
            AV17Open_Action = context.GetMessage( "K2BT_Notifs_Open", "");
            AssignAttri("", false, edtavOpen_action_Internalname, AV17Open_Action);
            AV11MarkAsRead_Action = context.GetMessage( "K2BT_MarkAsRead", "");
            AssignAttri("", false, edtavMarkasread_action_Internalname, AV11MarkAsRead_Action);
      ...
      protected void wb_table1_74_132( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_gridgetallnotificationsforcurrentuserdp_Internalname, context.GetMessage( "K2BT_NoResultsFound", ""), "", "", lblI_noresultsfoundtextblock_gridgetallnotificationsforcurrentuserdp_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BTools/DesignSystems/Aries/ViewAllNotifications.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_74_132e( true) ;
         }
         else
         {
            wb_table1_74_132e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462889", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2btools/designsystems/aries/viewallnotifications.js", "?2024341462889", false, true);
         context.AddJavascriptSource("shared/K2BToolsCommon.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void StartGridControl65( )
      {
         if ( GridgetallnotificationsforcurrentuserdpContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "NotificationId", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "K2BT_Notifs_NotificationText", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            ...
            context.SendWebValue( context.GetMessage( "EventTargetUrl", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "K2BT_Notifs_NotificationIsRead", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         chkavFreezecolumntitles_gridgetallnotificationsforcurrentuserdp.Caption = context.GetMessage( "K2BT_FreezeColumnTitles", "");
         ...
         Form.Caption = context.GetMessage( "View All Notifications", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'PAGINGFIRST(GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP)'","{handler:'E13131',iparms:[{av:'GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP_nFirstRecordOnPage'},{av:'GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP_nEOF'},{av:'AV28ClassCollection_GridGetAllNotificationsForCurrentUserDP',fld:'vCLASSCOLLECTION_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''},{av:'AV5CurrentPage_GridGetAllNotificationsForCurrentUserDP',fld:'vCURRENTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'ZZZ9'},{av:'AV9HasNextPage_GridGetAllNotificationsForCurrentUserDP',fld:'vHASNEXTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'',hsh:true},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18RowsPerPage_GridGetAllNotificationsForCurrentUserDP',fld:'vROWSPERPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'ZZZ9'},{av:'AV7DP_SDT_ITEM_GridGetAllNotificationsForCurrentUserDP',fld:'vDP_SDT_ITEM_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'',hsh:true},{av:'AV30FreezeColumnTitles_GridGetAllNotificationsForCurrentUserDP',fld:'vFREEZECOLUMNTITLES_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''}]");
         ...
         setEventMetadata("'PAGINGPREVIOUS(GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP)'","{handler:'E12131',iparms:[{av:'GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP_nFirstRecordOnPage'},{av:'GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP_nEOF'},{av:'AV28ClassCollection_GridGetAllNotificationsForCurrentUserDP',fld:'vCLASSCOLLECTION_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''},{av:'AV5CurrentPage_GridGetAllNotificationsForCurrentUserDP',fld:'vCURRENTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'ZZZ9'},{av:'AV9HasNextPage_GridGetAllNotificationsForCurrentUserDP',fld:'vHASNEXTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'',hsh:true},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18RowsPerPage_GridGetAllNotificationsForCurrentUserDP',fld:'vROWSPERPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'ZZZ9'},{av:'AV7DP_SDT_ITEM_GridGetAllNotificationsForCurrentUserDP',fld:'vDP_SDT_ITEM_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'',hsh:true},{av:'AV30FreezeColumnTitles_GridGetAllNotificationsForCurrentUserDP',fld:'vFREEZECOLUMNTITLES_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''}]");
         setEventMetadata("'PAGINGPREVIOUS(GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP)'",",oparms:[{av:'AV5CurrentPage_GridGetAllNotificationsForCurrentUserDP',fld:'vCURRENTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_gridgetallnotificationsforcurrentuserdp_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',prop:'Class'},{av:'AV27GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV30FreezeColumnTitles_GridGetAllNotificationsForCurrentUserDP',fld:'vFREEZECOLUMNTITLES_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''},{av:'AV28ClassCollection_GridGetAllNotificationsForCurrentUserDP',fld:'vCLASSCOLLECTION_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''}]}");
         setEventMetadata("'PAGINGNEXT(GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP)'","{handler:'E14131',iparms:[{av:'GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP_nFirstRecordOnPage'},{av:'GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP_nEOF'},{av:'AV28ClassCollection_GridGetAllNotificationsForCurrentUserDP',fld:'vCLASSCOLLECTION_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''},{av:'AV5CurrentPage_GridGetAllNotificationsForCurrentUserDP',fld:'vCURRENTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'ZZZ9'},{av:'AV9HasNextPage_GridGetAllNotificationsForCurrentUserDP',fld:'vHASNEXTPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'',hsh:true},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18RowsPerPage_GridGetAllNotificationsForCurrentUserDP',fld:'vROWSPERPAGE_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'ZZZ9'},{av:'AV7DP_SDT_ITEM_GridGetAllNotificationsForCurrentUserDP',fld:'vDP_SDT_ITEM_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:'',hsh:true},{av:'AV30FreezeColumnTitles_GridGetAllNotificationsForCurrentUserDP',fld:'vFREEZECOLUMNTITLES_GRIDGETALLNOTIFICATIONSFORCURRENTUSERDP',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         GXt_char1 = "";
         AV6DP_SDT_GridGetAllNotificationsForCurrentUserDP = new GXBaseCollection<GeneXus.Programs.k2btools.integrationprocedures.SdtWebNotificationSDT_Notification>( context, "Notification", "EstadoCuenta");
         GXt_objcol_SdtWebNotificationSDT_Notification2 = new GXBaseCollection<GeneXus.Programs.k2btools.integrationprocedures.SdtWebNotificationSDT_Notification>( context, "Notification", "EstadoCuenta");
