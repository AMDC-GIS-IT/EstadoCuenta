...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeCLAVES_RUTAS( )
      {
         string cmdBuffer = "";
         /* Indices for table CLAVES_RUTAS */
         try
         {
            cmdBuffer=" CREATE TABLE [GXA0004] ([CLAVE_CATASTRAL] nvarchar(255) NOT NULL , [CLAVES_RUTASRUTA] decimal( 17, 6) NOT NULL , [UMAPS] decimal( 17, 6) NULL , [ClavesRutaId] int NULL )  "
            ;
         ...
         /* API remote call */
         new claves_rutasconversion(context ).execute( ) ;
         try
         {
            DropTableConstraints( "[CLAVES_RUTAS]") ;
            cmdBuffer=" DROP TABLE [CLAVES_RUTAS] "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            ...
            {
               DropTableConstraints( "[CLAVES_RUTAS]") ;
               cmdBuffer=" DROP VIEW [CLAVES_RUTAS] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               {
                  DropTableConstraints( "[CLAVES_RUTAS]") ;
                  cmdBuffer=" DROP FUNCTION [CLAVES_RUTAS] "
                  ;
                  RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                  RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
                  RGZ.ExecuteStmt() ;
         ...
         RGZ.AddParameter("@newname","CLAVES_RUTAS");
         RGZ.ExecuteStmt();
         cmdBuffer=" ALTER TABLE [CLAVES_RUTAS] ADD PRIMARY KEY([CLAVE_CATASTRAL]) "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeCLAVES_RUTAS" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"CLAVES_RUTAS", ""}) );
      }
