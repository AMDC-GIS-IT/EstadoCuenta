...
namespace GeneXus.Programs {
   public class gx0040 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0040.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV13pART_ID_DOC))}, new string[] {"pART_ID_DOC"}) +"\">") ;
      ...
      {
         return formatLink("gx0040.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV13pART_ID_DOC))}, new string[] {"pART_ID_DOC"})  ;
      }
      ...
      protected void WB070( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblart_id_docfilter_Internalname, "ART_ID_DOC", "", "", lblLblart_id_docfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblact_id_cardfilter_Internalname, "ACT_ID_CARD", "", "", lblLblact_id_cardfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsector_coloniafilter_Internalname, "SECTOR_COLONIA", "", "", lblLblsector_coloniafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblnombre_coloniafilter_Internalname, "NOMBRE_COLONIA", "", "", lblLblnombre_coloniafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblobl_yearfilter_Internalname, "OBL_YEAR", "", "", lblLblobl_yearfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCobl_year_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10cOBL_YEAR), 4, 0, ".", "")), StringUtil.LTrim( ((edtavCobl_year_Enabled!=0) ? context.localUtil.Format( (decimal)(AV10cOBL_YEAR), "ZZZ9") : context.localUtil.Format( (decimal)(AV10cOBL_YEAR), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCobl_year_Jsonclick, 0, "Attribute", "", "", "", "", edtavCobl_year_Visible, edtavCobl_year_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldiasfilter_Internalname, "DIAS", "", "", lblLbldiasfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e16071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblimpuestofilter_Internalname, "IMPUESTO", "", "", lblLblimpuestofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e17071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e18071_client"+"'", TempTags, "", 2, "HLP_Gx0040.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      protected void RF072( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15IMPUESTO = H00072_A15IMPUESTO[0];
               n15IMPUESTO = H00072_n15IMPUESTO[0];
               A12NOMBRE_COLONIA = H00072_A12NOMBRE_COLONIA[0];
               n12NOMBRE_COLONIA = H00072_n12NOMBRE_COLONIA[0];
               A19MoraId = H00072_A19MoraId[0];
               n19MoraId = H00072_n19MoraId[0];
               A14DIAS = H00072_A14DIAS[0];
               n14DIAS = H00072_n14DIAS[0];
               A13OBL_YEAR = H00072_A13OBL_YEAR[0];
               n13OBL_YEAR = H00072_n13OBL_YEAR[0];
               A11SECTOR_COLONIA = H00072_A11SECTOR_COLONIA[0];
               n11SECTOR_COLONIA = H00072_n11SECTOR_COLONIA[0];
               A9ACT_ID_CARD = H00072_A9ACT_ID_CARD[0];
               A2ART_ID_DOC = H00072_A2ART_ID_DOC[0];
               /* Execute user event: Load */
               E20072 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20243411475542", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0040.js", "?20243411475542", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("LBLART_ID_DOCFILTER.CLICK","{handler:'E11071',iparms:[{av:'divArt_id_docfiltercontainer_Class',ctrl:'ART_ID_DOCFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLACT_ID_CARDFILTER.CLICK","{handler:'E12071',iparms:[{av:'divAct_id_cardfiltercontainer_Class',ctrl:'ACT_ID_CARDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLSECTOR_COLONIAFILTER.CLICK","{handler:'E13071',iparms:[{av:'divSector_coloniafiltercontainer_Class',ctrl:'SECTOR_COLONIAFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLNOMBRE_COLONIAFILTER.CLICK","{handler:'E14071',iparms:[{av:'divNombre_coloniafiltercontainer_Class',ctrl:'NOMBRE_COLONIAFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLOBL_YEARFILTER.CLICK","{handler:'E15071',iparms:[{av:'divObl_yearfiltercontainer_Class',ctrl:'OBL_YEARFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLDIASFILTER.CLICK","{handler:'E16071',iparms:[{av:'divDiasfiltercontainer_Class',ctrl:'DIASFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLIMPUESTOFILTER.CLICK","{handler:'E17071',iparms:[{av:'divImpuestofiltercontainer_Class',ctrl:'IMPUESTOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E21072',iparms:[{av:'A2ART_ID_DOC',fld:'ART_ID_DOC',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         lV9cNOMBRE_COLONIA = "";
         A12NOMBRE_COLONIA = "";
         H00072_A15IMPUESTO = new decimal[1] ;
         H00072_n15IMPUESTO = new bool[] {false} ;
         H00072_A12NOMBRE_COLONIA = new string[] {""} ;
         H00072_n12NOMBRE_COLONIA = new bool[] {false} ;
         H00072_A19MoraId = new int[1] ;
         H00072_n19MoraId = new bool[] {false} ;
         H00072_A14DIAS = new int[1] ;
         H00072_n14DIAS = new bool[] {false} ;
         H00072_A13OBL_YEAR = new short[1] ;
         H00072_n13OBL_YEAR = new bool[] {false} ;
         H00072_A11SECTOR_COLONIA = new short[1] ;
         H00072_n11SECTOR_COLONIA = new bool[] {false} ;
         H00072_A9ACT_ID_CARD = new string[] {""} ;
         H00072_A2ART_ID_DOC = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0040__default(),
            new Object[][] {
                new Object[] {
               H00072_A15IMPUESTO, H00072_n15IMPUESTO, H00072_A12NOMBRE_COLONIA, H00072_n12NOMBRE_COLONIA, H00072_A19MoraId, H00072_n19MoraId, H00072_A14DIAS, H00072_n14DIAS, H00072_A13OBL_YEAR, H00072_n13OBL_YEAR,
               H00072_A11SECTOR_COLONIA, H00072_n11SECTOR_COLONIA, H00072_A9ACT_ID_CARD, H00072_A2ART_ID_DOC
               }
               , new Object[] {
      ...
      private decimal[] H00072_A15IMPUESTO ;
      private bool[] H00072_n15IMPUESTO ;
      private string[] H00072_A12NOMBRE_COLONIA ;
      private bool[] H00072_n12NOMBRE_COLONIA ;
      private int[] H00072_A19MoraId ;
      private bool[] H00072_n19MoraId ;
      private int[] H00072_A14DIAS ;
      private bool[] H00072_n14DIAS ;
      private short[] H00072_A13OBL_YEAR ;
      private bool[] H00072_n13OBL_YEAR ;
      private short[] H00072_A11SECTOR_COLONIA ;
      private bool[] H00072_n11SECTOR_COLONIA ;
      private string[] H00072_A9ACT_ID_CARD ;
      private string[] H00072_A2ART_ID_DOC ;
   ...
   public class gx0040__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00072(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (int)dynConstraints[4] , (decimal)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (short)dynConstraints[9] , (int)dynConstraints[10] , (decimal)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] );
               case 1 :
                     return conditional_H00073(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (int)dynConstraints[4] , (decimal)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (short)dynConstraints[9] , (int)dynConstraints[10] , (decimal)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] );
         }
