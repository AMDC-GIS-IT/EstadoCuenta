   ...
   public class k2btoolscomponentplaceholder : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "K2 BTools Component Place Holder", "")) ;
      ...
      {
         return context.GetMessage( "K2 BTools Component Place Holder", "") ;
      }
      ...
      protected void WB2S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_2S2( true) ;
         }
         else
         {
            wb_table1_6_2S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2S2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "K2 BTools Component Place Holder", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void wb_table1_6_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_9_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_6_2S2e( true) ;
         }
         else
         {
            wb_table1_6_2S2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, context.GetMessage( "Loading...", ""), "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BToolsComponentPlaceHolder.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024341462071", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("k2btoolscomponentplaceholder.js", "?2024341462071", false, true);
         }
